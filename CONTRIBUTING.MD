...
```bash
git clone https://github.com/gcdevops/gcdevops.github.io.git <your_folder_name>
```
...
The generated website will be available at : [http://localhost:4000/](http://localhost:4000/)
...
For example, if the permalink is `/example.html`, the associated URL would be `https://gcdevops.github.io/example.html`
...
* Head out to `0.0.0.0:4000/` to view the website
